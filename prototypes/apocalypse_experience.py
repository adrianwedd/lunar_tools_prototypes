...
class ApocalypseExperience:
    def __init__(self, lunar_tools_art_manager: Manager, ambient_sound_file="apocalypse_ambient.mp3", loop_delay=1):
    ...
    def generate_apocalypse_visual(self):
        ...
        try:
            ...
            self.lunar_tools_art_manager.logger.error(f"Error generating apocalypse visual: {e}", exc_info=True)
