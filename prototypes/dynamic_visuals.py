...
class DynamicVisualizer:
    def __init__(self, lunar_tools_art_manager: Manager, midi_device_name="akai_lpd8", control_names=None, update_interval=0.1):
        ...
        self.control_names = control_names if control_names is not None else {
            "brightness": 'A0',
            "contrast": 'B0',
            "hue": 'C0'
        }
    ...
    def run(self):
        ...
        while True:
            ...
            brightness = self.midi_input.get(self.control_names["brightness"], val_min=0.5, val_max=1.5)
            contrast = self.midi_input.get(self.control_names["contrast"], val_min=0.5, val_max=1.5)
