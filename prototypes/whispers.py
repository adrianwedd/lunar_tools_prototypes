...
from lunar_tools_art import Manager
...
class Whispers:
    def __init__(self, lunar_tools_art_manager: LunarToolsArtManager):
        ...
        self.particles = []
        self.zones = [
            {"x": 100, "y": 100, "width": 200, "height": 200, "movement_detected": False},
            {"x": 500, "y": 100, "width": 200, "height": 200, "movement_detected": False},
            {"x": 300, "y": 300, "width": 200, "height": 200, "movement_detected": False}
        ]
    ...
    def _generate_sound(self):
        ...
        try:
            ...
            self.lunar_tools_art_manager.text2speech.generate(sound_description, filename=filename)
        ...
        while True:
            ...
            for i, zone in enumerate(self.zones):
                if self._detect_movement(i):
                    ...
                    self._create_burst_of_particles(zone["x"] + zone["width"] // 2, zone["y"] + zone["height"] // 2, 50)

            # Draw everything
            canvas_image = Image.new('RGB', (self.renderer.width, self.renderer.height), color = (0, 0, 0)) # Black background
            ...
            for zone in self.zones:
                draw.rectangle([zone["x"], zone["y"], zone["x"] + zone["width"], zone["y"] + zone["height"]], outline=(255, 0, 0, 100), width=2)
...
if __name__ == "__main__":
    from PIL import Image, ImageDraw # Import here for local testing
    from collections import deque # Import here for Particle class
