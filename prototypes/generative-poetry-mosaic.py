...
class GenerativePoetryMosaic:
    def __init__(self, lunar_tools_art_manager: Manager, font_path="arial.ttf", font_size=20):
        ...
        self.canvas = Image.new('RGB', (self.renderer.width, self.renderer.height), color = (0, 0, 0))
    ...
    def run(self):
        self.logger.info("Generative Poetry Mosaic: Type keywords and press Enter. Press 'q' to quit.")
        while True:
            ...
            try:
                ...
                if background_image is None:
                    self.logger.info("Could not generate background image. Try another keyword.")
                    continue
