...
class TimeTravelExperience:
    def __init__(self, lunar_tools_art_manager: Manager, midi_device_name="akai_lpd8", loop_delay=0.1):
    ...
    def generate_historical_visual(self, era):
        ...
        try:
            ...
            self.logger.error(f"Error generating visual for era {era}: {e}", exc_info=True)
    ...
    def run(self):
        ...
        while True:
            ...
            midi_value = self.midi_input.get('A0', val_min=0, val_max=len(self.historical_eras) - 1)
